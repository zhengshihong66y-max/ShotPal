...
for (en,zh) in [("ShotPal Pro","拉片宝 Pro"),("Version 1.2.1","版本 1.2.1"),("REQUIRES","系统要求"),("PROCESSOR","处理器"),("Apple silicon","Apple 芯片"),("DOWNLOAD","下载大小"),("Download DMG","下载 DMG")] {strip=strip.replacingOccurrences(of:en,with:zh)}
