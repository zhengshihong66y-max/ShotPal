...
- **音乐：** 用于查看主页识别出的音乐结果、下载原曲或伴奏、管理识别音乐标签。
- **设置：** 用于账号登录、下载器自检和快捷键查看。

当前左侧只保留以上四个工作区。字幕识别、字幕浏览、声音截取和字幕导出集中在主页时间线与导出面板里。
...
- 支持在设置页用默认浏览器登录 Instagram、小红书、YouTube、Bilibili 和抖音，拉片宝会优先识别默认浏览器或常见浏览器的登录态，不再依赖后台打开 Chrome。
...
- 支持下载主页识别音乐的原曲和伴奏，完成的下载会继续关联到对应识别结果。
- 非主页识别来源的音乐文件会移入 `音乐/非识别音乐打包`，不进入音乐工作区列表。
...
- **音乐工作区完善：** 音乐识别、下载、波形、标签和排序被整理成只面向主页识别结果的独立工作区能力。
